...
#make directories and place the spec2d pipeline output into separate
#subdirectories. Each file type gets its own directory. An auxilary files are
#left in the main mask directory.

echo "Beginning spec2d organization:"
